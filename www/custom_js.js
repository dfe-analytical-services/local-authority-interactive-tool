...
$(document).ready(function () {
  ...
  $("#region_multi_line-copybtn").on("click", async () => {
    ...
    // Event listener for "Regional focus line chart"
  $("#region_focus_bar-copybtn").on("click", async () => {
    await copyImage("region_focus_bar-copybtn", "region_focus_bar-copy_plot");
  });

    // Event listener for "Regional multi bar chart"
  $("#region_multi_bar-copybtn").on("click", async () => {
    await copyImage("region_multi_bar-copybtn", "region_multi_bar-copy_plot");
  });
});
